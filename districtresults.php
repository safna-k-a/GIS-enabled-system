                ...
                <div class="container">
                  ...
                  <div class="collapse navbar-collapse" id="navbarNav">
                    ...
                    <li class="nav-item">
                      ...
                      <li class="nav-item">
                      <form method="POST">
                        <a class="nav-link text-white" href="#" name="logout" onclick="return confirm('Are you sure?');"><i class="fa fa-sign-out" aria-hidden="true">Log out</a>
                        </form>
                      </li>
...
<div class="row p-0 m-0">
            ...
            <div class="col-12 col-sm-6 px-5 form-outer">
              <div class="px-5 form-div">
                <form action="" method="POST" class="filter-form bg-danger bg-opacity-50 rounded p-4">
                  <div class="text-dark fs-5">
                    You can search your destination based on district and rating.
                  </div>
                  <div class="pt-3 align-items-center">
                    <select id="mySelect" onchange="showSelect()" class="form-control rounded border border-danger mb-4" name="filter">
        ...
        <div class="results row p-0 m-0" id="card">
          <?php if(isset($_POST['district'])){ foreach($places as $p):
            $sql='SELECT * from images where place_id=:id';
            $statement=$connection->prepare($sql);
            $statement->execute([':id'=>$p->id]);
            $image=$statement->fetch(PDO::FETCH_OBJ);?>

          <div class="col-12 col-sm-4 d-flex justify-content-center mb-5 ">
            <div class="card shadow" style="width: 18rem;">
              <img src="uploads/<?= $image->image?>" class="card-img-top" alt="..." height="200px">
              <div class="card-body">
                <h4 class="card-title"><?=$p->place_name?></h4>
                <p class="card-text"><?=$p->description?></p>
                <a href="main_index.php?id=<?= $p->id?>" class="btn btn-primary">View details</a>
              </div>
            </div>
          </div>
          <?php endforeach; }?>
